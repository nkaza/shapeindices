...
``` r
radial_concentration_index_sf(x, ...)
```
...
- ...:
  ...
  passed to radial_concentration_index() for every row

## Value

`x` with one new column, radial_concentration_index
...
#> [1] 0.9832083 0.8844106 0.9684172 0.6540012 0.8622902
```
